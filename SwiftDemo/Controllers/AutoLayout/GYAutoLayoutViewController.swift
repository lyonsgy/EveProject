//
//  GYAutoLayoutViewController.swift
//  SwiftDemo
//
//  Created by lyons on 2020/11/12.
//  Copyright © 2020 lyons. All rights reserved.
//

import UIKit

class GYAutoLayoutViewController: UIViewController {
    ...
    func testScrollView(){
        ...
        for i in 0..<3{
            ...
            view.topAnchor.constraint(equalTo: scrollView.topAnchor, constant: 200).isActive = true
            view.bottomAnchor.constraint(equalTo: scrollView.bottomAnchor, constant: -200).isActive = true
            view.widthAnchor.constraint(equalTo: scrollView.widthAnchor, multiplier: 0.5).isActive = true
            view.heightAnchor.constraint(equalTo: scrollView.heightAnchor, multiplier: 0.5).isActive = true
            leftView = view
        }
    ...
    func testSimple(){
        ...
        //添加距离顶部20
        let topConstraint = NSLayoutConstraint.init(item: redView, attribute: .top, relatedBy: .equal, toItem: view, attribute: .top, multiplier: 1.0, constant: 200)
